export PATH=~/.cargo/bin:~/.local/bin:/usr/local/bin:~/bin:~/local/bin:~/.local/opt/go/bin:~/.local/opt/nvim/bin:~/.local/opt/node/bin:./node_modules/.bin:~/.local/opt/jdk/bin:~/.local/opt/zig:$PATH
