return {
                        ...
                        (function()
                            ...
                            return function()
                                ...
                                if neotest.statusline.running then
                                    spinner_index = (spinner_index + 1) % spinner_len
                                    return spinner[spinner_index + 1] .. " " .. neotest.statusline.lualine
                                end
    ...
    },
    {
        ...
        keys = {
            ...
            { "<leader>lai",     function() Snacks.picker.lsp_incoming_calls() end,                      desc = "LSP Incoming Calls" },
            { "<leader>lao",     function() Snacks.picker.lsp_outgoing_calls() end,                      desc = "LSP Outgoing Calls" },
            -- Other
    ...
    },
    {
        ...
        keys = {
            ...
            { "<leader>lld",  "<cmd>Trouble lsp_definitions toggle<cr>",          desc = "LSP Definition List", },
            { "<leader>llD",  "<cmd>Trouble lsp_declarations toggle<cr>",         desc = "LSP Declaration List", },
            { "<leader>llr",  "<cmd>Trouble lsp_references toggle<cr>",           desc = "LSP Reference List", },
            { "<leader>lli",  "<cmd>Trouble lsp_implementations toggle<cr>",      desc = "LSP Implementation List", },
            { "<leader>llt",  "<cmd>Trouble lsp_type_definitions toggle<cr>",     desc = "LSP Type Definition List", },
            { "<leader>lls",  "<cmd>Trouble lsp_document_symbols toggle<cr>",     desc = "LSP Symbol List", },
            { "<leader>llai", "<cmd>Trouble lsp_incoming_calls toggle<cr>",       desc = "LSP Incoming Call List" },
            { "<leader>llao", "<cmd>Trouble lsp_outgoing_calls toggle<cr>",       desc = "LSP Outgoing Call List" },
        },
    },
    {
